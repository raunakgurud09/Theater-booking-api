...
import { seeAllShows, seeShowDetailsHandler } from "../controller/show.controller";
import { showDetails } from "../services/show.service";
...
Router.get('/:screen/shows',validateRequest(showDetailsSchema),seeShowDetailsHandler)
Router.get('/:screen/show/:showId',validateRequest(showDetailsSchema),seeShowDetailsHandler)
